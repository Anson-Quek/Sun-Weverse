...
class Community:
    ...
    id: :class:`int`
        ...
        that contains the :class:`sunverse.objects.Artist` objects using
        the :method:`fetch_artists` method.
    name: :class:`str`
    ...
    fandom_name: Optional[:class:`str`]
        The name of the fandom of the community, if any.
    fan_event_url: Optional[:class:`str`]
    ...
    def __init__(self, data: dict):
        ...
        self.code: Optional[str] = data.get("artistCode")
        ...
        self.fandom_name: Optional[str] = data.get("fandomName")
        self.fan_event_url: Optional[str] = data.get("fanEventUrl")
