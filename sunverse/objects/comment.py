class BaseParent:
    ...
    - :class:`sunverse.objects.ParentComment`
    - :class:`sunverse.objects.ParentPost`
    - :class:`sunverse.objects.ParentMediaPost`
    ...
    author: :class:`sunverse.objects.BaseAuthor`
        The :class:`sunverse.objects.BaseAuthor` object of the parent author
...
class ParentComment(BaseParent):
    ...
    :class:`sunverse.objects.BaseParent`.

    Shares the same attributes with :class:`sunverse.objects.BaseParent`.
    ...
    id: :class:`str`
        ...
        comment is required by the user, the :method:`fetch_comment` method
        can be used to fetch the actual :class:`sunverse.objects.Comment` object.
...
class ParentPost(BaseParent):
    ...
    id: :class:`str`
        ...
        post is required by the user, the :method:`fetch_post` method
        can be used to fetch the actual :class:`sunverse.objects.Post` object.
...
class ParentMediaPost(ParentPost):
    ...
    :class:`sunverse.objects.BaseParent` and :class:`sunverse.objects.ParentPost`.

    Shares the same attributes with :class:`sunverse.objects.BaseParent` and
    :class:`sunverse.objects.ParentPost`.
...
class RootPost(ParentPost):
    ...
    author: :class:`sunverse.objects.Author`
        The :class:`sunverse.objects.Author` object of the author
...
class RootMediaPost(ParentMediaPost):
    ...
    :class:`sunverse.objects.BaseParent`, :class:`sunverse.objects.ParentPost`
    and :class:`sunverse.objects.ParentMediaPost`.

    Shares the same attributes with :class:`sunverse.objects.BaseParent`,
    :class:`sunverse.objects.ParentPost` and :class:`sunverse.objects.ParentMediaPost`.
...
class Comment:
    ...
    def parent(self) -> ParentComment | ParentMediaPost | ParentPost:
        """Union[:class:`sunverse.objects.ParentComment`,
        :class:`sunverse.objects.ParentPost`,
        :class:`sunverse.objects.ParentMediaPost`]:

        - Returns the :class:`sunverse.objects.ParentComment` object
        if the parent is a comment.
        - Returns the :class:`sunverse.objects.ParentMediaPost` object
        if the parent is a media.
        - Returns the :class:`sunverse.objects.ParentPost`
        object if the parent is a post.
        """
    ...
    def root(self) -> RootMediaPost | RootPost:
        """Union[:class:`sunverse.objects.RootMediaPost`,
        :class:`sunverse.objects.RootPost`]:

        - Returns the :class:`sunverse.objects.RootMediaPost` object
        if the root post is a media post.
        - Returns the :class:`sunverse.objects.RootPost`
        object if the root post is a normal post.
        """
        post_types = ["NORMAL", "MOMENT", "OFFICIAL"]
...
class BaseAuthor:
    ...
    id: :class:`str`
        ...
        required by the user, the :method:`fetch_member` method can be used to
        fetch the actual :class:`sunverse.objects.Member` object.
    name: :class:`str`
...
class Author(BaseAuthor):
    """Represents a Weverse Author. Inherits from :class:`sunverse.objects.BaseAuthor`.

    Shares the same attributes with :class:`sunverse.objects.BaseAuthor`.
