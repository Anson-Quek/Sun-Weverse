...
class Video:
    ...
    from this object. As a workaround, please make use of the :method:`fetch_video_url`
    method to make an additional API call to fetch the video URL.
    """
...
class Snippet:
    ...
    def __init__(self, data: dict):
        ...
        self.site: Optional[str] = data.get("site")
